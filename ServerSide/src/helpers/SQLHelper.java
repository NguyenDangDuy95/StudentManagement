...
public class SQLHelper {
    ...
    public static String getFullInfoEmployeeList() {
        return "SELECT EmployeeList.EmployeeID,FirstName,LastName,PositionName,PayRate,Gender,BirthDay,PersonalID,Email,PhoneNumber,Address,BirthPlace,FatherName, MontherName,FatherJob,MotherJob,ParentPhone,StartDate,EndDate \n"
